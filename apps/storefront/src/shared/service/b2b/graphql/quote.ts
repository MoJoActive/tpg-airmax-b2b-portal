...
export const getB2BCustomerAddresses = (companyId: number, customMessage = false) =>
  B3Request.graphqlB2B(
    {
...
export const updateB2BQuote = updateQuote;
export const updateBCQuote = updateQuote;
